...
CONFIG_DECODER = ['units', 'num_layers', 'max_seq_length']
...
import salento.models.low_level_evidences.evidence
...
def read_config(js, chars_vocab=False):
    ...
    config.evidence = salento.models.low_level_evidences.evidence.Evidence.read_config(js['evidence'], chars_vocab)
